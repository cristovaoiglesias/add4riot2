...
def save_index_as_text(index):
    with open('/Users/cristovao/Devel/csi5137_course/crowdre-glossary-master/target/terms.txt', 'w') as f:
        for term in index:
            termstring = ""
            for element in term:
...
def save_index_as_xlsx(index, reqs, ids):
    ...
    wb.save('/Users/cristovao/Devel/csi5137_course/crowdre-glossary-master/target/glossary.xlsx')
