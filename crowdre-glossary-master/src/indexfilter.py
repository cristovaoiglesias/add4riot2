...
def create_filter_index():
        ...
        with open('/Users/cristovao/Devel/csi5137_course/crowdre-glossary-master/temp/filter_index.pickle','wb') as f:
...
def index_filter(index,no_reqs,threshold_coverage=5,filter_mode=["threshold"],times=1):
    ...
    if "specificity" in filter_mode:
        filtered_keys = []
        print(filtered_keys)
        with open('/Users/cristovao/Devel/csi5137_course/crowdre-glossary-master/temp/filter_index.pickle','rb') as f:
...
def analyze_index_filter(index,reqs,ids,description="Analysis of index filter",covered_range=11,output='memory',filenames=['/Users/cristovao/Devel/csi5137_course/crowdre-glossary-master/target/number_of_glossary_terms_by_filter_threshold.pdf','/Users/cristovao/Devel/csi5137_course/crowdre-glossary-master/target/coverage_by_filter_threshold.pdf','/Users/cristovao/Devel/csi5137_course/crowdre-glossary-master/target/double_coverage_by_filter_threshold.pdf']):
    print()
    print(description)
