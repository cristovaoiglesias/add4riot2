...
def gt_read(max_lines=-1):
    gt = []
    i = 0
    with open('/Users/cristovao/Devel/csi5137_course/crowdre-glossary-master/data/ground_truth.csv', newline='') as csvfile:
...
def reqs_read(read_tags=False,max_lines=-1):
    ...
    tags = []
    i = 0
    with open('/Users/cristovao/Devel/csi5137_course/crowdre-glossary-master/data/requirements.csv', newline='') as csvfile:
        reader = csv.DictReader(csvfile)
        for row in reader:
