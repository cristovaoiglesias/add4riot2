...
def save_tagger(tagger, tagger_name):
    with open('/Users/cristovao/Devel/csi5137_course/crowdre-glossary-master/temp/'+tagger_name+'.pickle','wb') as f:
        pickle.dump(tagger,f)

def load_tagger(tagger_name):
    with open('/Users/cristovao/Devel/csi5137_course/crowdre-glossary-master/temp/'+tagger_name+'.pickle','rb') as f:
        return pickle.load(f)

def reqs_tag(reqs,ids,mode='load',tagger_name='tagger'):
    if mode=='load':
        with open('/Users/cristovao/Devel/csi5137_course/crowdre-glossary-master/temp/tagged_reqs.pickle','rb') as f:
