def dataset():
    dt=[("Bring me your embedded RFID chips, show me your QR codes, hit me with your location-based web apps.",{"entities": [(23,27,"Device")]}),
    ...
    ("Ground IR and radar sensors are used to cue the aerostat imaging sensor to identify targets.",{"entities": [(57, 71, "Device")]}),
    ("This sensor is compact and reliable for use in the cover gas hydrogen meter in place of the katharometer.",{"entities": [(5, 11, "Device")]}),
    ("In construction the katharometer comprises two chambers, each with an identical thermal conductivity sensor.",{"entities": [(101, 107, "Device")]}),
    ("Based on Rayleigh scattering, the sensor can be used to monitor perimeters around secure facilities and prisons.",{"entities": [(34, 40, "Device")]}),
    ("Most modern sensors are electronic and work on the principle that temperature, pressure or stress affects the electrical behaviour of the sensor.",{"entities": [(138, 144, "Device")]}),
    ("Another switch will open a system or door only when its sensor reads the eyeballs of the owner.",{"entities": [(56, 62, "Device")]}),
    ("It registers the severity of the crash by reading the deceleration data from the airbag's sensor.",{"entities": [(90, 96, "Device")]}),
    ("You've got to orient your own hand exactly or the sensor won't read it correctly.",{"entities": [(50, 56, "Device")]}),
    ("The hard real-time system would guarantee that sensor inputs would not be missed.",{"entities": [(47, 53, "Device")]}),
    ("The new rheometer provides an extended torque range, a new normal force sensor with high stability and accuracy.",{"entities": [(72, 78, "Device")]}),
    ("The data recorder is part of the sensor in every vehicle that triggers the air bag in a crash.",{"entities": [(33, 39, "Device")]}),
    ("A sensor in the heel measures changes in compression each time the wearer's foot hits the ground.",{"entities": [(2, 8, "Device")]}),
    ("A microprocessor, as small as a postage stamp, performs thousands of calculations per second based on readings from the sensor.",{"entities": [(120, 126, "Device")]}),
    ("The research team is now exploring the possibility of using eye contact sensor glasses to treat children with autistic spectrum disorder.",{"entities": [(72, 78, "Device")]}),
    ("Each sensor of the array undergoes a reversible change in electrical resistance when exposed to a vapor or analyte.",{"entities": [(5, 11, "Device")]}),
    ("Unlike the torque sensor on Miller's car, which is fitted around the pinion shaft, Kalitta's is bolted to the back of the reverser.",{"entities": [(18, 24, "Device")]}),
    ...
    ("The new sensor allows the user to communicate with each sensor element of the array by computer.",{"entities": [(8, 14, "Device")]}),
    ("A second gas volume flow sensor is located in the connection line between the patient connection piece and the patient being respirated.",{"entities": [(25, 31, "Device")]}),
    ("In addition, almost all come with a laser sensor, which picks up emissions from a laser gun as used in portable traps.",{"entities": [(36, 48, "Device")]}),
    ("The sensor could be inserted into tissue, excited with a laser pointer, and provide real-time, continuous monitoring of blood glucose level.",{"entities": [(4, 10, "Device")]}),
    ("The temperature of the water bath is controlled by a microprocessor and a temperature sensor.",{"entities": [(74, 92, "Device")]}),
    ("The sensor can time this journey down to the nanosecond, ESA says, meaning that the instrument is accurate to within two centimetres.",{"entities": [(4, 10, "Device")]}),
    ("In addition, a cheap sensor cannot distinguish between a water pipe, a structural beam and a power cable.",{"entities": [(21, 27, "Device")]}),
    ("These systems use radar as the surveillance and cueing sensor to achieve this.",{"entities": [(48, 61, "Device")]}),
    ("Microwave sensor data, thermal and radiometric information etc. can be got even under adverse weather conditions or cloud cover.",{"entities": [(0, 16, "Device")]}),
    ("The screen also has both a variable brightness control as well as an ambient light sensor that automatically adjusts to the environment.",{"entities": [(77, 89, "Device")]}),
    ("The oxygen sensor was inserted through the bark side in the same way as for the trees in the arboretum.",{"entities": [(4, 17, "Device")]}),
    ("Other options include 6-disc in-dash CD autochanger, sunroof and parking distance sensor.",{"entities": [(73, 88, "Device")]}),
    ("In tall canopies, the operator moves beneath the canopy along a linear path, keeping the sensor oriented to the sun with the help of a sight.",{"entities": [(89, 95, "Device")]}),
    ("The optical sensor functions as a rangefinder, measuring the height of the target beneath the missile and profiling the target simultaneously.",{"entities": [(4, 18, "Device")]}),
    ("The wireless sensor technology is used to monitor pressure within an aortic aneurysm.",{"entities": [(4, 12, "Resource"]]}
    ("The sculpture is embedded with 3,000 toy dogs whose little synchronized yaps are triggered by a hidden motion sensor.",{"entities": [(103, 116, "Device")]}),
    ("Optimal sensor placement is desirable to ensure adequate coverage of the network's flow for detection and remediation of contaminants.",{"entities": [(8, 14, "Device")]}),
    ("The concept of the device is to activate a remote sensor that will trigger the device on the vehicle that will bring it to a stop.",{"entities": [(50, 56, "Device")]}),
    ("A small sensor, the accelerometer, placed nearby then detects the sound waves and analyses their acoustic signature.",{"entities": [(8, 14, "Device")]}),
    ("The breaker trips when the sensor determines that the amperage at the hot terminal is not equal to the amperage at the neutral terminal.",{"entities": [(27, 33, "Device")]}),
    ("We were communicating fairly well and I was about to renew my questions as to how he came to be here when the sensor alert sounded.",{"entities": [(110, 116, "Device")]}),
    ("In late 2009 Borkholder wrote a white paper proposal to DARPA that pitched a disposable blast gauge using a tiny pressure sensor.",{"entities": [(113, 128, "Device")]}),
    ("When said light enters your bloodstream only a portion is reflected and returned to the sensor thus giving you your readout.",{"entities": [(88, 94, "Device")]}),
    ("I told her several days ago I thought the yardmen damaged the backyard rain sensor when they trimmed the shrubs but God forbid we should listen to Rana.",{"entities": [(71, 82, "Device")]}),
    ("On many projects, said O'Mahony, the engineering team is left trying to fight science by being asked to achieve some unrealistic sensor or actuator accuracies.",{"entities": [(129, 135, "Device")]}),
    ("If a given tackle exceeds a certain level of force, the sensor is activated and the player is notified to seek medical attention.",{"entities": [(56, 62, "Device")]}),
    ("Instead, a remote sensor placed outdoors transmits a radio signal to a monitor inside your house, which shows the data on a liquid crystal display.",{"entities": [(18, 24, "Device")]}),
    ("The laser sensor locates the positions of the leading and trailing edges of the tank, and the magnetic sensor provides confirmation of the position of the tank.",{"entities": [(4, 16, "Device")]}),
    ("An anemometric flow sensor, developed at the EPFL is packaged for long-term implantation in the human body for a shunt catheter for the hydrocephalus.",{"entities": [(15, 26, "Device")]}),
    ("With the built-in smart fingerprint sensor, the tablet's security lock can be released by simply placing the finger of a pre-registered user on the sensor.",{"entities": [(24, 42, "Device")]}),
    ("When your late-model car's oxygen sensor goes on the fritz, it will impair operation of the catalytic converter and probably cause your car to flunk its next emission test.",{"entities": [(27, 40, "Device")]}),
    ("If commandos get a new weapon or sensor, it probably will be used on a real mission or battlefield.",{"entities": [(33, 39, "Device")]}),
    ("Although the windows were not linked to the burglar alarm, a sensor activated the system and a passing police patrol stopped to check the building.",{"entities": [(61, 67, "Device")]}),
    ("A specialised machine that uses the latest in optical and high speed sensor technology to search for skeleton weed is in the advanced stages of development.",{"entities": [(63, 75, "Device")]}),
    ("You'll also find cruise control, driver and front passenger airbags, tyre pressure sensor, athermic windscreen and automatic headlights.",{"entities": [(74, 89, "Device")]}),
    ("By supercooling the sensor even small variations in temperature can be detected at long range.",{"entities": [(20, 26, "Device")]}),
    ("The IIR sensor has a stabilised mount so that it can maintain a target within its field of view.",{"entities": [(8, 14, "Device")]}),
    ("Both Sector and Slave Acquisition demonstrate the level of sensor fusion present in the Typhoon.",{"entities": [(59, 65, "Device")]}),
    ("Block 2A software enhanced simulated weapons, data link capabilities, and early fused sensor integration.",{"entities": [(86, 92, "Device")]}),
    ("Lockheed Martin's Dave Scott stated that sensor fusion boosts engine thrust and oil efficiency, increasing the aircraft's range.",{"entities": [(41, 47, "Device")]}),
    ("To overcome this, the Typhoon employs what are now known as sensor fusion techniques.",{"entities": [(60, 66, "Device")]}),
    ("When behind an absorbing mask, the CZT sensor array can determine the direction of the rays.",{"entities": [(39, 45, "Device")]}),
    ("A foil strain gage wired in a fundamental Wheatstone bridge circuit is at the core of the sensor to provide excellent temperature stability.",{"entities": [(90, 96, "Device")]}),
    ("I can't help thinking that, had he lived to see the electronic cricket sensor, the inventor of the opeidoscope probably would have approved.",{"entities": [(71, 77, "Device")]}),
    ("Small turbines are pointed by a simple wind vane, while large turbines generally use a wind sensor coupled with a servomotor.",{"entities": [(87, 98, "Device")]}),
    ("The light and rotation are activated automatically by a photoelectric sensor.",{"entities": [(56, 76, "Device")]}),
    ("This is due to the UES moving completely off the sensor as it moves orad with the swallow.",{"entities": [(49, 55, "Device")]}),
    ("The second category of sensor channels is in the microwave part of the electromagnetic spectrum.",{"entities": [(23, 29, "Device")]}),
    ("Displays for the air traffic controllers may be live video, synthetic images based on surveillance sensor data, or both.",{"entities": [(99, 105, "Device")]}),
    ("The sensor uses highly calibrated internal electronics to measure the response of the device to the Earth's magnetic field.",{"entities": [(4, 10, "Device")]}),
    ("The conductive properties of powdered graphite allow its use as pressure sensor in carbon microphones.",{"entities": [(64, 79, "Device")]}),
    ("Effectively, the downlead and uplead for an individual sensor in the simple array becomes the downlead and uplead for a ladder in the subarray.",{"entities": [(55, 61, "Device")]}),
    ("There's a back-illuminated sensor, autofocus, face detection, digital zoom, geo tagging, night mode, and an LED flash.",{"entities": [(27, 33, "Device")]}),
    ("The automaker said there are two sensors in the airbag sensor assembly which are designed to detect vehicle roll angle.",{"entities": [(33, 39, "Device")]}),
    ("A biometric sensor is embedded in the wrist band, and the assembly also houses a GPS receiver, a barometer, a depth sensor and a thermometer.",{"entities": [(2, 18, "Device"], [110, 122, "Device")]}),
    ("Researchers at Newcastle University and Microsoft Research Cambridge have developed a sensor the size of a wrist watch.",{"entities": [(86, 92, "Device")]}),
    ("Thermopile sensor scans particular angle with output signal depending on angle of incidence.",{"entities": [(0, 17, "Device")]}),
    ("The sensor may aid in quantitating attached bacteria and in defining or extending operating cycle times for the industry.",{"entities": [(4, 10, "Device")]}),
    ("It features a number of sensor specifications, including rain gauge, wind speed and direction, temperature, humidity, and total solar radiation.",{"entities": [(24, 30, "Device")]}),
    ("Station crew members installed a series of jumper cables, bypassing the sensor, and the Poisk module hooks retracted.",{"entities": [(72, 78, "Device")]}),
    ("By modifying the method employed to control the readout circuit timing, Canon achieved the high-speed readout of sensor signals.",{"entities": [(113, 119, "Device")]}),
    ("By modifying the method employed to control the readout circuit timing, Canon successfully achieved the high-speed readout of sensor signals.",{"entities": [(126, 132, "Device")]}),
    ("This sensor non-destructively and reproducibly applies a known set of optical properties to the object being imaged.",{"entities": [(5, 11, "Device")]}),
    ("Due to variations in thin film composition, sensor resistivities fluctuate.",{"entities": [(44, 50, "Device")]}),
    ("High sensitivity, selectivity and reusability are among the advantages of the sensor.",{"entities": [(78, 84, "Device")]}),
    ("It acts as a band-pass filter in the microwave frequency range and it can be also used in sensor applications.",{"entities": [(90, 96, "Device")]}),
    ("The LIF sensor was featured at the 2010 IFPAC show as well as 2010 INTERPHEX NY and received much attention from potential customers.",{"entities": [(4, 14, "Device")]}),
    ("Two or more monomorphs can be incorporated into one sensor to form a bimorph or multimorph respectively.",{"entities": [(52, 58, "Device")]}),
    ("Agilent's LTM technology eliminates the conventional GC oven by wrapping the GC column with a heating element and temperature sensor.",{"entities": [(114, 132, "Device")]}),
    ("The standard design features of the EyeCon 2000 sensor provide binocular vision inspection to observe the target from two different directions.",{"entities": [(48, 54, "Device")]}),
    ("The sensor form factor will be the same for all versions with different software tuned to the body mechanics and reporting needs of each sport.",{"entities": [(4, 10, "Device")]}),
    ("The remaining mechs went to the port side of the aircraft to prep for leak checks on the FVG sensor.",{"entities": [(89, 99, "Device")]}),
    ("The four sensor camera provides 8 megapixels of high definition video over the entire panoramic view.",{"entities": [(9, 15, "Device")]}),
    ("This garage parking sensor lets you know how close you are to the wall to make reverse parking a sinch.",{"entities": [(20, 26, "Device")]}),
    ("The sensor will use wireless communications for power and to telemeter sensor data.",{"entities": [(61, 77, "Device")]}),
    ("This sensor system, which records nip width, renders obsolete time-consuming and inexact tools such as carbon paper and embossed foils.",{"entities": [(5, 11, "Device")]}),
    ("Moreover, Koubachi is the only product using a patented soil moisture sensor technology that works like a tensiometer.",{"entities": [(61, 76, "Device")]}),
    ("Next, we had to transform FOV of each sensor from spherical coordinate system into Cartesian coordinates.",{"entities": [(38, 44, "Device")]}),
    ("We demonstrated a chemiresistive sensor based on core-shell hybridized nanostructures of Fe 3 O 4 and PEDOT for the efficient detection of VOC biomarkers.",{"entities": [(33, 39, "Device")]}),
    ("The robust IR sensing architecture also operates in direct sunlight and includes an ambient light sensor capable of sensing light levels up to 128 kilolux.",{"entities": [(92, 104, "Device")]}),
    ("Another factor to consider is disposable versus rebuildable sensor bodies.",{"entities": [(60, 66, "Device")]}),
    ("Using MyDealerLot, Andean Chevrolet deployed 375 AeroScout motion sensor Wi-Fi tags to the rear-view mirrors of their new and used vehicle inventory.",{"entities": [(59, 72, "Device")]}),
    ("In July 2013, further doubt was cast on the latest production schedule, with further software delays and continuing sensor, display and wing buffet problems.",{"entities": [(116, 122, "Device")]}),
    ("Micron leads the industry in shrinking pixels, creating a smaller sensor form factor for today's razor-thin phone designs, all the while maintaining picture quality.",{"entities": [(66, 72, "Device")]}),
    ("The device, Philips Sleepwave, is attached to the mastoid bone behind the ear using a sensor cable and it works by sending electric pulses into the vestibular system.",{"entities": [(86, 92, "Device")]}),
    ("The CROWS sensor suite includes a daytime video camera, a second-generation forward-looking infrared sight, and a laser range finder for day and night missions.",{"entities": [(10, 16, "Device")]}),
    ("This system consisted of two instrument platforms with four-band radiometers and a datalogger to sample and store radiometer sensor voltages and time of measurement.",{"entities": [(114, 131, "Device")]}),
    ("The ANS program will provide navigational, perception, path-planning and vehicle-following algorithms and the requisite on-board sensor package for autonomous mobility.",{"entities": [(129, 135, "Device")]}),
    ("Integrating avionics systems on a flying test bed will reduce the need for sensor flights during the Engineering and Manufacturing Development phase of the program.",{"entities": [(75, 81, "Device")]}),
    ("Unlike competing devices, the power and size advantages of the AD7980 allow designers to incorporate the new ADC and a digital interface into analog sensor packages.",{"entities": [(149, 155, "Device")]}),
    ("The MCT200SS Snack Food Transmitter offers the snack food industry a process hardened online sensor for the simultaneous measurement of these two critical constituents.",{"entities": [(93, 99, "Device")]}),
    ("For real applications a specific receiver is immobilized on the sensor surface which is supposed to interact with a potential addend ligature to be determined.",{"entities": [(64, 70, "Device")]}),
    ("When that occurs, the device does not measure the amount of methane that the second sensor would capture, and so it underrecords methane leakage rates.",{"entities": [(84, 90, "Device")]}),
    ("The proximity of the heat source allowed it to be detected by the sensor.",{"entities": [(66, 72, "Device")]}),
    ("The acquisition provides Micron with an experienced imaging team, select imaging products and intellectual property relating to Avago's image sensor business.",{"entities": [(136, 148, "Device")]}),
    ("A pressure sensor, supplied by Honeywell's Microswitch division, Morristown, NJ, is used to measure the level of negative pressure applied to the pads.",{"entities": [(2, 17, "Device")]}),
    ("Rockweed, a specialist in fitouts for restaurants and shops launched from its stall its Darna brand of products including LED lamps, sensor trash bins and fancy clocks.",{"entities": [(133, 139, "Device")]}),
    ("Rockweed, a specialist in fit-outs for restaurants and shops, launched from its stall its Darna brand of products including LED lamps, sensor trash bins and fancy clocks.",{"entities": [(135, 141, "Device")]}),
    ("Ben-Dot E, Levin N, Singer A, Karnieli A, Braun O, Kidron GJ Quantitative mapping of the soil rubification process on sand dunes using an airborne hyperspectral sensor.",{"entities": [(147, 167, "Device")]}),
    ("Rockweed, a specialist in fit-outs for restaurants and shops launched from its stall its Darna brand of products including LED lamps, sensor trash bins and fancy clocks.",{"entities": [(134, 140, "Device")]}),
    ("Retia is the original equipment manufacturer of the Czech Army s fire command and control system, the combat command post and the new Revisor short range radar sensor.",{"entities": [(160, 166, "Device")]}),
    ("Commonly a semiconductor radiation detection sensor is used that can also provide spectrographic information on the contamination being collected.",{"entities": [(45, 51, "Device")]}),
    ("We have shown that fast sampling is possible using noncontacting laser probing, and we have presented a working preliminary configuration for the sensor.",{"entities": [(146, 152, "Device")]}),
    ("This sensor can detect acetone, chloroform, cyclohexane, N,N-dimethylformide, ethanol, ethyl acetate, hexane, methanol, carbon tetrachloride, tetrahydrofuran, and toluene.",{"entities": [(5, 11, "Device")]}),
    ("In rubber and tire applications where spot size is important, the sensor should be mounted with the laser beam as close to perpendicular to the surface as possible.",{"entities": [(66, 72, "Device")]}),
    ("The x-ray backscatter sensor, which will be shown for the first time at NPE in Chicago next month, uses an ionization chamber to detect reflected x-rays.",{"entities": [(22, 28, "Device")]}),
    ("For instance, when Abbott and his colleagues attached a receptor called biotin to the lipids, the sensor detected a bacterial protein that binds to biotin.",{"entities": [(98, 104, "Device")]}),
    ("Instead of scanning every item individually, an RFID till would simply total up every item in your shopping trolley as it approached.",{"entities": [(48,52,"Device")]}),
    ("When a trucker whose RFID card grants him port access approaches the gate, the gate goes up, and the tire shredders stay down.",{"entities": [(21,25,"Device")]}),
    ("The RFID microreaders, RFID tags and EDTP readers are not available locally.",{"entities": [(4,8,"Device")]}),
    ("Today, over a million pets and farm animals worldwide have RFID tags in or on them, so Rover or Daisy can easily be tracked if they wander off.",{"entities": [(59,63,"Device")]}),
    ("The basic idea is that you carry a personalized device that jams the signals from all the RFID tags on your person until you authorize otherwise.",{"entities": [(90,94,"Device")]}),
    ("These chips act as transponders, always listening for a radio signal sent by transceivers, or RFID readers.",{"entities": [(94,98,"Device")]}),
    ("Clever people at the University of Rochester have flipped the typical use of RFID around and created a navigational aid for the visually impaired.",{"entities": [(77,81,"Device")]}),
    ("Unlike their bar code counterparts, tags embedded with RFID chips can still operate if torn or otherwise damaged.",{"entities": [(55,59,"Device")]}),
    ("The plugged-in device identifies itself as a Human Interface Device and inputs RFID tag data into any existing applications.",{"entities": [(79,83,"Device")]}),
    ("Most RFID tags contain an integrated circuit for storing and processing information, modulating and demodulating a signal.",{"entities": [(5,9,"Device")]}),
    ("It provides complete verification of the RFID data and overstrikes bad labels to alert users if the RFID data cannot be encoded.",{"entities": [(41,45,"Device")]}),
    ("DoD Components will immediately resource and implement the use of high data capacity active RFID in the DoD operational environment.",{"entities": [(92,96,"Device")]}),
    ("In the same year, the Telepass active transponder RFID system was introduced across Italy.",{"entities": [(50,54,"Device")]}),
    ("The Amtech RFID technology used on the Dallas North Tollway was originally developed at Sandia Labs for use in tagging and tracking livestock.",{"entities": [(11,15,"Device")]}),
    ("Virginia may become the first state to glue RFID tags into all its driver's licenses.",{"entities": [(44,48,"Device")]}),
    ("The passport's critical information is stored on a tiny RFID computer chip, much like information stored on smartcards.",{"entities": [(56,60,"Device")]}),
    ("Any RFID interrogator within 30 meters can read an RFID tag in active mode.",{"entities": [(4,8,"Device")]}),
    ("When goods are received at the Future Store, employees transport the pallets from the truck through an RFID gate at the backstore entrance.",{"entities": [(103,107,"Device")]}),
    ("This patent covers systems and methods for using RFID tags in biopharmaceutical environments where gamma radiation is used for sterilization.",{"entities": [(49,53,"Device")]}),
    ("Utilizing equipment from numerous RFID suppliers in Europe and North America, Checkpoint served as a hardware integrator for the trials.",{"entities": [(34,38,"Device")]}),
    ("The technical skills, industry experience, and clients of SJS will position us as a dominant player in the RFID implementation space today.",{"entities": [(107,111,"Device")]}),
    ("Recently, BSF has started taking RFID to a new level internally and is in the process of automating its receiving and shipping processes.",{"entities": [(33,37,"Device")]}),
    ("Stratum Global along with Intermec and other industry leaders have helped create an RFID program at Oakton Community College.",{"entities": [(84,88,"Device")]}),
    ("Truth is, some universities are already using RFID technology, although use is limited.",{"entities": [(46,50,"Device")]}),
    ...
    ("Since RFID tags will eventually be placed on or in corrugated packaging, there are major implications for corrugated container manufacturers and their customers.",{"entities": [(6,10,"Device")]}),
    ("In 2003, Michelin began testing RFID transponders embedded into its tires.",{"entities": [(32,36,"Device")]}),
    ("Patents that generally relate to the lamination process for RFID cards that use an embedded chip to enable secure financial payments and access to secure locations.",{"entities": [(60,64,"Device")]}),
    ("Acsis is an EPCglobal member and early adopter of RFID technologies.",{"entities": [(50,54,"Device")]}),
    ("The design not only allows easy on-site maintenance but also reserves space for further expandability on Wi-Fi, MSR, IC card reader, fingerprint, and RFID module.",{"entities": [(150,154,"Device")]}),
    ("Our study used the information entropy to measure the uncertainty of the RFID data streams, and analyzed the features that could influence cleaning effect.",{"entities": [(73,77,"Device")]}),
    ("Rfid uses teeny computer chips, smaller than half-a-grain of sand, to track items at a distance.",{"entities": [(-1,3,"Device")]}),
    ...
    ("The Global MEMS accelerometer market has also been witnessing an increasing number of MEMS accelerometer applications in safeguarding laptop hard disks.",{"entities": [(16,29,"Device")]}),
    ("accelerometer based games require simple gestures while playing and developers can use the simple motion of the device to control the game.",{"entities": [(0,13,"Device")]}),
    ("accelerometer is a kind of electronic equipment that can measure accelerating force.",{"entities": [(0,13,"Device")]}),
    ...
    ("smart tv ads give a nod to the sport's village background.",{"entities": [(0,8,"Device")]}),
    ("Samsung said the ability to control the TV using voice commands can be activated or deactivated by the user and that the smart tv displayed when it is actively listening.",{"entities": [(121,129,"Device")]}),
    ("Users will be able to connect any Wifi enabled tablet, smart tv, iptv, game console, set top box and phone to the Teleport Wifi router to obtain a US IP Address.",{"entities": [(55,63,"Device")]}),
    ("The launch is being backed up by a smart tv ad and a targeted advertising campaign to boost awareness of the performance drink in Switzerland.",{"entities": [(35,43,"Device")]}),
    ("This platform promises an even smarter smart tv experience, via on-demand news and social interaction, as well as integration with mobile devices.",{"entities": [(39,47,"Device")]}),
    ("The webOS smart tv is intuitive and attractive.",{"entities": [(10,18,"Device")]}),
    ("It has a voice control option and, of course, it's a smart tv too.",{"entities": [(53,61,"Device")]}),
    ("Intel lets you experience more of the things you love, enabling intelligent devices like smart tv and creating new ways for people to connect to each other, to content, and to other devices.",{"entities": [(89,97,"Device")]}),
    ("It then concluded:Yet even if it produces a cheaper iPhone, pushes deep into China and wows the world with a smart tv, its shares will not reconquer last year's peak.",{"entities": [(109,117,"Device")]}),
    ("To date smart tv manufacturers such as Samsung, Panasonic and LG have struck individual deals to make their catch-up TV services available, meaning viewers can only access certain services on particularinternet-enabled sets",{"entities": [(8,16,"Device")]}),
    ...
    ("The Xpedio Content Publisher enables users to publish content to WML standards that are specific to mobile phone microbrowsers.",{"entities": [(100,112,"Device")]}),
    ("Results from Vodafone's mobile phone recycling scheme show that Sligo and Cork are tops when it comes to mobile phone recycling.",{"entities": [(24,36,"Device")]}),
    ("Tethering is a feature that lets your mobile phone share its wireless data connection with your computer.",{"entities": [(38,50,"Device")]}),
    ("He has not been heard from since and has not returned any calls or texts to his mobile phone, she said.",{"entities": [(80,92,"Device")]}),
    ("There's a URL encoded in the QR code that a new mobile phone application first decodes then launches the browser in your mobile to find.",{"entities": [(48,60,"Device")]}),
    ("Any mobile phone can receive texts and it keeps you in close touch with your money.",{"entities": [(4,16,"Device")]}),
    ("I'd just switched off the tape recorder and switched on the mobile phone when a text popped up to say that the deal had finally been done.",{"entities": [(60,72,"Device")]}),
    ("In recent weeks we have reported on scams perpetrated by post, fax and mobile phone text message.",{"entities": [(71,83,"Device")]}),
    ("The answers were then looked up and sent by mobile phone text message to students in the test hall.",{"entities": [(44,56,"Device")]}),
    ("Each inquiry will cost the same as a regular text message depending on the mobile phone operator.",{"entities": [(75,87,"Device")]}),
    ("And today we make it easier than ever to join the cause by allowing you to add your name by mobile phone text message.",{"entities": [(92,104,"Device")]}),
    ("Many mobile phone networks now provide free text messaging or services for as little as 10p a message.",{"entities": [(5,17,"Device")]}),
    ("For the first time in the UK voting can be done by the Internet and mobile phone text messaging, as well as by traditional ballot papers.",{"entities": [(68,80,"Device")]}),
    ("They also showed that on-board systems ignored the Bluetooth traffic generated by an infected mobile phone.",{"entities": [(94,106,"Device")]}),
    ("Moves are afoot to include some mobile phone textspeak in the official dictionary of the game beloved by generations.",{"entities": [(32,44,"Device")]}),
    ("He had pulled up outside to take a call on his mobile phone, and seen the smoke and flames in the thatch.",{"entities": [(47,59,"Device")]}),
    ("There was a pool table, a small bank of computers and a corpulent Italian speaking loudly into a mobile phone.",{"entities": [(97,109,"Device")]}),
    ("Previously, radar needed massive fixed equipment to work and transmissions from mobile phone masts were thought too weak to be useful.",{"entities": [(80,92,"Device")]}),
    ("The argument that third generation mobile phone technology is non-essential and, therefore, fair game for the Nimby brigade, is flawed.",{"entities": [(35,47,"Device")]}),
    ("Yefu took only a few necessary things with him, including a cup, a mobile phone, and bedding.",{"entities": [(67,79,"Device")]}),
    ("The phone user can then transfer a ticket using NFC to a friend's mobile phone.",{"entities": [(66,78,"Device")]}),
    ("Motorola has designed quite a lot of useful accessories around its T720i mobile phone.",{"entities": [(73,85,"Device")]}),
    ("The accursed mobile phone has done what I often wished it would, and disappeared.",{"entities": [(13,25,"Device")]}),
    ("Nokia did receive better news with the continued turnaround in its mobile phone division.",{"entities": [(67,79,"Device")]}),
    ("It seems mobile phone is the medium of choice for communication for modern Japanese.",{"entities": [(9,21,"Device")]}),
    ("Furious residents are battling for the second time to stop huge mobile phone masts going up in Corsham town centre.",{"entities": [(64,76,"Device")]}),
    ("This stylish mobile phone has room for up to 3,000 of your favourite tracks along with a 2 megapixel digital camera.",{"entities": [(13,25,"Device")]}),
    ("Do that, and we may start flicking through the address book on your mobile phone.",{"entities": [(68,80,"Device")]}),
    ("Friday night came and in the absence of a digital watch I synchronised my mobile phone clock.",{"entities": [(74,86,"Device")]}),
    ("Disposing of the tub in the kitchen tidy, she searched the lounge room for her mobile phone and wallet.",{"entities": [(79,91,"Device")]}),
    ("Common sense dictates that it is dangerous to use a mobile phone while driving.",{"entities": [(52,64,"Device")]}),
    ("Residents fighting proposals to build mobile phone masts on a former water tower have won crucial backing.",{"entities": [(38,50,"Device")]}),
    ("Make sure you have enough warm clothing, that your mobile phone is fully charged, and take a vacuum flask with a hot drink.",{"entities": [(51,63,"Device")]}),
    ("And that's without mentioning the wide skies, the winding roads and a blissful lack of mobile phone reception.",{"entities": [(87,99,"Device")]}),
    ("Teenagers I've spoken to have compared it to a parent checking through the messages on their mobile phone without asking.",{"entities": [(93,105,"Device")]}),
    ("She was in the kitchen when I arrived, simultaneously rabbiting into a mobile phone while watching a soap opera on television.",{"entities": [(71,83,"Device")]}),
    ("The volume of mobile phone traffic has increased and what operators are demanding is that there are no blind spots.",{"entities": [(14,26,"Device")]}),
    ("The only count on which he was found not guilty was of stealing a mobile phone and car radio from Mr Ducey.",{"entities": [(66,78,"Device")]}),
    ("On the train from Swansea to Carmarthen I sat next to a mobile phone addict.",{"entities": [(56,68,"Device")]}),
    ("These are transmitters that use radio waves to communicate with mobile phone handsets.",{"entities": [(64,76,"Device")]}),
    ("We have all raged at those dangerous idiots who insist on driving one-handed down the motorway at 80 mph while gabbling into a mobile phone.",{"entities": [(127,139,"Device")]}),
    ("He said five two-way radios, a pair of binoculars and an expensive waterproof mobile phone were stolen in the raid on their hut.",{"entities": [(78,90,"Device")]}),
    ("The legislation should have been introduced years ago before the advent of extensive mobile phone use.",{"entities": [(85,97,"Device")]}),
    ("A vicar has done a dramatic 11 th hour U-turn over controversial plans to set up a mobile phone mast on top of a church tower.",{"entities": [(83,95,"Device")]}),
    ("About 60 per cent of Europe's population already lives within range of a mobile phone transmitter.",{"entities": [(73,85,"Device")]}),
    ("She had just checked her coat in and met her friends in the bar when her mobile phone rang.",{"entities": [(73,85,"Device")]}),
    ("He was about to dictate into his recorder about the progress of his work when his mobile phone rang.",{"entities": [(82,94,"Device")]}),
    ("The intimacy of the mobile phone creates a similarly fragmented network of communication and desire.",{"entities": [(20,32,"Device")]}),
    ("I've had a mobile phone for ten years. Not the same phone, obviously. My first one was a brick.",{"entities": [(11,23,"Device")]}),
    ("That mobile phone companies should find themselves weakened just as the sector was about take off makes many afraid for its future stability.",{"entities": [(5,17,"Device")]}),
    ("It's actually a good thing because it means people cannot reach me in the evenings when all they have is a mobile phone number.",{"entities": [(107,119,"Device")]}),
    ("The study compares the reaction times of drivers who are talking on a mobile phone.",{"entities": [(70,82,"Device")]}),
    ("A gun was held to a teenage girl's neck by a mugger who robbed her of her mobile phone.",{"entities": [(74,86,"Device")]}),
    ("But the objectors believe that the mobile phone company is to appeal against the decision.",{"entities": [(35,47,"Device")]}),
    ("A mobile phone or PDA with a bar-code reader would simply scan the object's code to download any relevant information.",{"entities": [(2,14,"Device")]}),
    ("Some mobile service agents will also provide you with a replacement mobile phone while yours is being repaired.",{"entities": [(68,80,"Device")]}),
    ("The reality of motherhood is trainers, a fleece, a worry list and a mobile phone.",{"entities": [(68,80,"Device")]}),
    ("I reckon since I arrived and purchased my mobile phone I have keyed in and later deleted at least 25 numbers.",{"entities": [(42,54,"Device")]}),
    ("I'm morbidly compelled by stuff filmed on a mobile phone such as the tsunami.",{"entities": [(44,56,"Device")]}),
    ("Apple takes you back to when a mobile phone was a brick, not the neat little gadgets they are now.",{"entities": [(31,43,"Device")]}),
    ...
    ("Both the PF8d and PF8t support dozens of 1D and many of the popular 2D symbologies, including DataMatrix and QR code.",{"entities": [(109,116,"Device")]}),
    ("Employees use their smartphones with QR Inventory mobile application installed to scan QR code or barcode on the item and submit inventory transaction.",{"entities": [(87,94,"Device")]}),
    ("The ultra-light DT-X7 hand-held scanner from CASIO is now available with CMOS imager, enabling it to read one and two-dimensional ident codes such as DataMatrix or QR code quickly and securely.",{"entities": [(164,171,"Device")]}),
    ("Waveline believes that people will really enjoy using the PhoneBook Exchange app, since using a QR code to share text and contacts is instantaneous and free.",{"entities": [(96,103,"Device")]}),
    ("Previous studies of this phenomenon have focused mainly on systems combining cholesterol with PC and sphingolipids.",{"entities": [(94,96,"Device")]}),
    ("I absolutely hate it when installing something screws your PC up so much that it is unusable.",{"entities": [(59,61,"Device")]}),
    ("Excellent build quality, attractive lines and some clever features add up to luxury housing for your PC bits.",{"entities": [(101,103,"Device")]}),
    ("There's no PC Card slot, of course, but with analogue modem, wired Ethernet and unwired 802.11 available, we don't need one.",{"entities": [(11,13,"Device")]}),
    ("If you care about upgradeability to prolong the lifespan of your investment, then a desktop PC is a smarter choice for you.",{"entities": [(92,94,"Device")]}),
    ("Detective Constable Ian Thornton and PC Kim Wandless tracked Wood down to a tunnel under King's Road and he was arrested.",{"entities": [(37,39,"Device")]}),
    ("Ceding the desktop PC market, for most a break-even prospect at best, to Dell wouldn't be so bad.",{"entities": [(19,21,"Device")]}),
    ("If the addressee is on another PC then the text is sent via the resident network.",{"entities": [(31,33,"Device")]}),
    ("The idea that that a PC might transmit on his radio whilst his partner was administering the breath test was frowned upon.",{"entities": [(21,23,"Device")]}),
    ("The software turns a PC equipped with a microphone, speakers, and broadband connection into a 21st century telephone.",{"entities": [(21,23,"Device")]}),
    ("The key to their technology, however, is a unique user interface, which allows the small screen to show a full PC display.",{"entities": [(111,113,"Device")]}),
    ("When Simon turned off Bradford Road into a housing estate, PC Jones lost sight of him.",{"entities": [(59,61,"Device")]}),
    ("Another feature enables users so inclined to connect their PC sound card to their TV audio output.",{"entities": [(59,61,"Device")]}),
    ("While soundbars are becoming ever more popular in home theater use, this speaker is a fairly novel design for the PC industry.",{"entities": [(114,116,"Device")]}),
    ("A code is produced based upon the Product key and various details pertaining to your PC hardware.",{"entities": [(85,87,"Device")]}),
    ("You'll know that your network hardware is set up properly when every PC in your home has internet access.",{"entities": [(69,71,"Device")]}),
    ("The PC receives a signal from the device handler indicating that a component is in place and that the test can begin.",{"entities": [(4,6,"Device")]}),
    ("Leaving the PC plugged in, touch a metal surface inside the computer to dissipate static electricity, which can zap a PC's tiny circuits.",{"entities": [(12,14,"Device")]}),
    ("It's logical not to want a soulless existence in an air-conditioned office, with a PC staring you in the face and stack of returns to input.",{"entities": [(83,85,"Device")]}),
    ("It also operates as a digital camcorder, with up to three minutes of continuous video, and may be used as a PC Camera.",{"entities": [(108,110,"Device")]}),
    ("Corsair has introduced Obsidian Series 750D Airflow Edition full-tower PC case.",{"entities": [(71,73,"Device")]}),
    ("American PC giant Dell launched two affordable Android-powered Venue series tablets in India today.",{"entities": [(9,11,"Device")]}),
    ("Jacolyn Ansell, 49, from Wolverhampton, was infatuated with PC Joseph Paros and was desperate to talk to him.",{"entities": [(60,62,"Device")]}),
    ("United Devices actively participates in several emerging working groups within the GGF that are especially relevant to PC grids.",{"entities": [(119,121,"Device")]}),
    ("Neighbourhood Sergeant Andy Dark and PC Chris Gunnel will be logged on and ready to take questions from the local community between 6pm and 8pm.",{"entities": [(37,39,"Device")]}),
    ("Plug this foam dart firing machine into the USB port of your PC and prepare to repel pilferers of pens and rubber robbers.",{"entities": [(61,63,"Device")]}),
    ("Property offers comp HSIA in guestrooms and Wi-Fi in public areas plus use of a PC and printer on the mezzanine level.",{"entities": [(80,82,"Device")]}),
    ("Presumably, neither the relentless EastEnders PC machine nor poor put-upon Pam innately disapprove of transvestism.",{"entities": [(46,48,"Device")]}),
